...
function scr_rhythmgame_load_events(arg0)
{
    if (arg0 == 0)
    {
        with (drums)
        {
            ...
            if (global.chapter == 3)
            {
                ...
                scr_music_event_add_instance(other.vocals.performer, 16.7 - (meter * 4), "sprite_index", 5366, true);
            ...
            scr_music_event_add_instance(other.vocals.performer, 38, "sprite_index", 1814, true, 1);
            ...
            scr_music_event_add_instance(other.vocals.performer, 134.5, "sprite_index", 1814, true, 1);
    ...
    else if (arg0 == 1)
    {
        with (drums)
        {
            ...
            scr_music_event_add_instance(other.vocals.performer, trackstart + (meter * 1), "sprite_index", 1814, true, 1);
            scr_music_event_add(trackstart + (meter * 2), "fade", 1, false);
            scr_music_event_add_instance(performer, 11, "sprite_index", 5822, true);
            scr_music_event_add_instance(performer, 14.3, "image_speed", 1, true);
            scr_music_event_add_instance(other.vocals.performer, 14.3, "sprite_index", 5366, true);
            ...
            scr_music_event_add_instance(performer, 23.5, "sprite_index", 30, true);
            scr_music_event_add_instance(performer, 24, "sprite_index", 3479, true);
        }
    }
    else if (arg0 == 2)
    {
        ...
        if (global.chapter > 3 || (chart_start <= 158.92 && chart_end >= 158.92))
        {
            with (vocals.performer)
            {
                ...
                scr_music_event_add(158.92, "sprite_index", 5310, true);
                scr_music_event_add(162.16, "sprite_index", 5271, true);
    ...
    else if (arg0 == 10)
    {
        ...
        scr_music_event_add_instance(vocals.performer, 49.22, "sprite_index", 5700, true, 1);
        scr_music_event_add_instance(vocals.performer, 53.52, "sprite_index", 1814, true, 1);
        scr_music_event_add_instance(vocals.performer, 132.91, "sprite_index", 5700, true, 1);
    }
    else
    {
        drums.auto_play = true;
    ...
    scr_music_beat_event_instance(196, "beat", true, true);
}
